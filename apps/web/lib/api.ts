...
// at the external API here - that's what was causing browser requests to
// bypass the Next.js routes and hit money-circle-api.vercel.app directly.
...
export const apiClient = {
  ...
  dueContributions: () =>
    api.get<DueContribution[]>("/payments/due").then((r) => r.data),
  payContribution: (contributionId: string) =>
    api
      .post("/payments/contributions/initialize", { contributionId })
      .then((r) => r.data),
